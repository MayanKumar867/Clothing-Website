...
const Add = () => {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-b from-[#ffe0f0] via-[#eafff6] to-[#ffffff] text-black overflow-x-hidden relative'>
      <Nav />
      <Sidebar />

      <div className='w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute  right-0 bottom-[5%]'>
        <form onSubmit={handleAddProduct} action="" className='w-[100%] md:w-[90%] h-[100%]  mt-[70px] flex flex-col gap-[30px] py-[90px] px-[30px] md:px-[60px]'>
          ...
          <div className='w-[80%] h-[130px] flex items-start justify-center flex-col mt-[20px]  gap-[10px] '>
            ...
            <div className='w-[100%] h-[100%] flex items-center justify-start '>
              ...
              <label htmlFor="image1" className=' w-[65px] h-[65px] md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#46d1f7]'>
                ...
                <input id='image1' type="file" className='hidden' onChange={(e) => setImage1(e.target.files[0])} />
              </label>
          ...
          <div className='w-[80%] h-[100px] flex items-start justify-center flex-col  gap-[10px]'>
            ...
            <input type="number" placeholder='₹ 1000' className='w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]' onChange={(e) => setPrice(e.target.value)} value={price} required />
          </div>
          ...
          <div className='w-[80%] flex items-center justify-start gap-[10px] mt-[20px]'>
            ...
            <button className='w-[140px] px-[20px] py-[20px] rounded-xl bg-black flex items-center justify-center gap-[10px] text-white active:bg-slate-700 active:text-white active:border-[2px] border-white'>Add Product</button>
        </form>
