  ...
  return (
    <div className='w-[100vw] h-[70px] bg-white z-10 fixed top-0 flex  items-center justify-between px-[30px] shadow-md shadow-black  '>
      ...
      <div className='w-[20%] lg:w-[30%] flex items-center justify-start   gap-[10px] '>
          ...
          <h1 className='text-[25px] text-[black] font-sans '>Riyu's Fashon</h1>
      </div>

      <div className='w-[50%] lg:w-[40%] hidden md:flex'>
            <ul className='flex items-center justify-center gap-[19px] text-[white] '>
                <li className='text-[15px] text-black font-medium cursor-pointer relative after:content-[""] after:block after:h-[2px] after:w-0 after:bg-amber-950 after:transition-all after:duration-300 hover:after:w-full' onClick={()=>navigate("/")}>HOME</li>
                <li className='text-[15px] text-black font-medium cursor-pointer relative after:content-[""] after:block after:h-[2px] after:w-0 after:bg-amber-950 after:transition-all after:duration-300 hover:after:w-full ' onClick={()=>navigate("/collection")}>COLLECTIONS</li>
                <li className='text-[15px] text-black font-medium cursor-pointer relative after:content-[""] after:block after:h-[2px] after:w-0 after:bg-amber-950 after:transition-all after:duration-300 hover:after:w-full' onClick={()=>navigate("/about")}>ABOUT</li>
                <li className='text-[15px] text-black font-medium cursor-pointer relative after:content-[""] after:block after:h-[2px] after:w-0 after:bg-amber-950 after:transition-all after:duration-300 hover:after:w-full' onClick={()=>navigate("/contact")}>CONTACT</li>
            </ul>
        </div>
        <div className='w-[30%] flex items-center justify-end gap-[20px]'>
            ...
            {!userData && <FaCircleUser className='w-[38px] h-[38px] text-[#000000]  cursor-pointer' onClick={()=>setShowProfile(prev=>!prev)}/>}
            {userData && <div div className='w-[30px] h-[30px] bg-[#080808] text-[white] rounded-full flex items-center justify-center cursor-pointer' onClick={()=>setShowProfile(prev=>!prev)}>{userData?.name.slice(0,1)} </div>}
            <MdOutlineShoppingCart onClick={()=>navigate("/cart")} className='w-[29px] h-[29px] text-[#000000]  cursor-pointer hidden md:block '/>
